<h2><a href="https://leetcode.com/problems/largest-number-after-digit-swaps-by-parity/?envType=company&envId=salesforce&favoriteSlug=salesforce-thirty-days">2231. Largest Number After Digit Swaps by Parity</a></h2><h3>Easy</h3><hr><p>You are given a positive integer <code>num</code>. You may swap any two digits of <code>num</code> that have the same <strong>parity</strong> (i.e. both odd digits or both even digits).</p>
